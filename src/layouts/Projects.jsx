  ...
  return (
    <section className='m-auto border-b-[3px] border-r-4 border-r-black border-b-black  border-l-4 border-t-2 border-l-[#F6BFA8]  border-t-[#F6BFA8] texture relative overflow-hidden py-2 gap-5  rounded-sm flex  flex-col items-center w-[90%] h-[90%]'>
      ...
      <article className='bg-yellow-400 flex flex-col gap-5 items-center  shadow-2xl/40 border-b-[4.7px] border-r-[7px] border-b-black/50 border-r-black/50 border-[5px] border-white/80 p-2 rounded relative w-[300px] h-[380px]'>
        ...
        <p className='press-start-2p-regular text-shadow-2xs text-shadow-black text-red-700 text-center'>Invoice Navigator</p>
        <div className='w-full flex justify-center rounded items-center'>
          <img className='w-[250px]' src='/public/projects/392_1x_shots_so.png' alt='' />
        </div>
        <img className='absolute opacity-[0.3] bottom-[-12px] right-14  m-auto w-[180px]' src='/projects/yoshi.webp' alt='carnivorous plant image of mario bros' />

        <div className='flex items-end justify-center h-full gap-2'>

          <button className='cursor-pointer border-[6px] shadow-2xl/80  border-red-950/70 border-b-[4px] border-t-[4px] border-b-black/60 border-t-black/60 rounded z-2 vt323-regular text-shadow-2xs text-shadow-black text-2xl text-white bg-red-700 px-5'>
            Ver mas
          </button>
